#Given an array of n distinct integers, transform the array into 
...
#decreasing order, where k = (n+1)/2. You need to find the 
#lexicographically smallest zig zag sequence of the given array.

def findZigZagSequence(a, n):
    a.sort()
    mid = int(n//2)
    #no necesitas una variable auxiliar para intercambiar valores 
